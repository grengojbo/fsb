...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Balance.accountcode'
        db.alter_column('balance', 'accountcode_id', self.gf('common.fields.AutoOneToOneField')(to=orm['auth.User'], unique=True, primary_key=True))


    def backwards(self, orm):
        
        # Changing field 'Balance.accountcode'
        db.alter_column('balance', 'accountcode_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True))
    ...
    models = {
        ...
        'billing.balance': {
            ...
            'accountcode': ('common.fields.AutoOneToOneField', [], {'to': "orm['auth.User']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        'billing.balancehistory': {
            ...
            'pay_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 4, 23, 33, 52, 695505)'}),
        ...
        'tariff.tariffplan': {
            ...
            'date_start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 4, 23, 33, 52, 669482)'}),
