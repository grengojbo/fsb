...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('balance', (
            ('id', orm['billing.Balance:id']),
            ('accountcode', orm['billing.Balance:accountcode']),
            ('cash', orm['billing.Balance:cash']),
            ('enabled', orm['billing.Balance:enabled']),
            ('timelimit', orm['billing.Balance:timelimit']),
            ('credit', orm['billing.Balance:credit']),
        ))
    ...
    models = {
        ...
        'billing.balance': {
            ...
            'cash': ('django.db.models.fields.DecimalField', [], {'max_digits': '18', 'decimal_places': '10'}),
