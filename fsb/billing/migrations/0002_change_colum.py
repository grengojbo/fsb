...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CreditBase.balance'
        db.alter_column('balance_credit', 'balance_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))


    def backwards(self, orm):
        
        # Changing field 'CreditBase.balance'
        db.alter_column('balance_credit', 'balance_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['billing.Balance']))
    ...
    models = {
        ...
        'billing.balancehistory': {
            ...
            'pay_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 21, 15, 32, 38, 202481)'}),
        ...
        'tariff.tariffplan': {
            ...
            'date_start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 21, 15, 32, 38, 177027)'}),
