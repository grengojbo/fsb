...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TariffPlan.pay_round'
        db.add_column('tariff_plan', 'pay_round', self.gf('django.db.models.fields.SmallIntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TariffPlan.pay_round'
        db.delete_column('tariff_plan', 'pay_round')
    ...
    models = {
        ...
        'tariff.tariff': {
            ...
            'date_start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 20, 23, 33, 29, 352982)'}),
        ...
        'tariff.tariffplan': {
            ...
            'date_end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(9999, 12, 31, 23, 59, 59, 999999)'}),
            'date_start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 20, 23, 33, 29, 346056)'}),
