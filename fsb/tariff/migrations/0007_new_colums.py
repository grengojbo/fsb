...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TariffPlan.limit_day'
        db.add_column('tariff_plan', 'limit_day', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'TariffPlan.limit_month'
        db.add_column('tariff_plan', 'limit_month', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TariffPlan.limit_day'
        db.delete_column('tariff_plan', 'limit_day')

        # Deleting field 'TariffPlan.limit_month'
        db.delete_column('tariff_plan', 'limit_month')
    ...
    models = {
        ...
        'tariff.tariffplan': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'limit_day': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'limit_month': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
